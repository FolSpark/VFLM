...
train_files=datasets/svg-data/data/train_rl_nothink.parquet   # 数据
test_files=datasets/svg-data/data/test_rl_nothink.parquet

MODEL_PATH=LF_models/qwen2.5_vl_7b_svg-nothink_from_v3_2025-08-16
# MODEL_PATH=models/Qwen2.5-VL-7B-Instruct

PROJECT_NAME=design_rl
# RUN_NAME="rl_grpo_svg_nothink_7b_from_sft8k_wo_ocr-2025-08-21"
RUN_NAME="rl_grpo_svg_nothink_7b_from_sft8k-RF++baseline-2025-09-12"

# RUN_NAME="rl_grpo_svg_nothink_from_pretrained_7b-2025-08-21"
# RUN_NAME="rl_grpo_svg_nothink_from_pretrained_7b-RF++baseline-2025-08-26"
...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.reward_manager=svg_layout_wo_think \
    ...
    trainer.nnodes=2 $@ 2>&1 | tee "${DIR}/work_dirs/${RUN_NAME}/verl-training.log"
