...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/mnt/yscfs/zhangshengzhuo/rl/dataset/kk/base')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--data_path', default='/mnt/yscfs/zhangshengzhuo/rl/Logic-RL/K-and-K/knights-and-knaves/train/people3_num1000.jsonl')
