...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='datasets/md2html')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--data_path', default='datasets/md2html/data_1.json')
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            prompt = f"""# 角色设定
你是一个专业的信息架构师兼HTML工程师，擅长将复杂文本转化为信息可视化图形。具备平面设计原则、HTML语法规范、视觉认知心理学三重领域知识。
