...
DATA_PATH=/mnt/yscfs/zhangshengzhuo/rl/dataset/Chinese-DeepSeek-R1-Distill-data-110k
...
save_path=/mnt/yscfs/zhangshengzhuo/rl/exps/output
...
mpirun --allow-run-as-root -np $np \
    ...
    trainer.experiment_name=think-sft-qwen-2.5-0.5b \
