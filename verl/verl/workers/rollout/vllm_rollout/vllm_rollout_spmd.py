...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if "multi_modal_data" in non_tensor_batch:
            vllm_inputs = []
            for raw_prompt_ids, multi_modal_data in zip(non_tensor_batch.pop("raw_prompt_ids"), non_tensor_batch["multi_modal_data"]):
        ...
        with self.update_sampling_params(**kwargs):
            ...
            if self.sampling_params.n > 1 and do_sample:
                ...
                if "origin_multi_modal_data" in non_tensor_batch.keys():
                    non_tensor_batch["origin_multi_modal_data"] = _repeat_interleave(non_tensor_batch["origin_multi_modal_data"], self.sampling_params.n)
