...
def _get_merged_dataset(
    ...
    data_args: "DataArguments",
    training_args: "Seq2SeqTrainingArguments",
    stage: Literal["pt", "sft", "rm", "rm_image", "ppo", "kto"],
    merge: bool = True,
    ...
    for dataset_name, dataset_attr in zip(dataset_names, get_dataset_list(dataset_names, data_args.dataset_dir)):
        if ((stage == "rm" or stage == "rm_image") and dataset_attr.ranking is False) or ((stage != "rm" and stage != "rm_image") and dataset_attr.ranking is True):
...
def _get_dataset_processor(
    ...
    if stage == "pt":
        ...
        dataset_processor_class = PairwiseImageDatasetProcessor
    elif stage == "kto":
