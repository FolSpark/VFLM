...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='data/datasets/svg-data/data/data_0424_rm.json')
    ...
    train_dataset.to_parquet(os.path.join(local_dir, 'train_rm.parquet'))
    test_dataset.to_parquet(os.path.join(local_dir, 'test_rm.parquet'))
