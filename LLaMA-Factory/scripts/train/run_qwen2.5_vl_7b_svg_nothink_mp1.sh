...
RUN_NAME="qwen2.5_vl_7b_svg-nothink_from_sft+rl_2025-09-14"


mkdir -p work_dirs/${RUN_NAME}

accelerate launch --num_machines 2 --num_processes ${GPU_NUM} --machine_rank 1 --main_process_ip 10.0.4.171 --main_process_port 29502 --mixed_precision bf16  \
  src/train.py \
    ...
    --dataset_dir data \
    --dataset layout_svg_nothink_from_sft_rl_train \
    --eval_dataset layout_svg_nothink_from_sft_rl_test \
    --tokenized_path data/datasets/svg-data/tokenized_nothink_from_sft+rl \
